...
const reportMetrics = [
  { name: "New Vehicles", value: 45, color: "hsl(var(--primary))" },
  { name: "Used Vehicles", value: 32, color: "hsl(var(--accent))" },
  { name: "Trade-Ins", value: 18, color: "hsl(var(--muted-foreground))" },
  { name: "Leases", value: 12, color: "hsl(var(--destructive))" },
];

export function DashboardReportingTab() {
  return (
