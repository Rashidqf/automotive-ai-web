...
export type Database = {
  ...
  public: {
    Tables: {
      dealerships: {
        Row: {
          ...
          login_id: string
          name: string
          status: Database["public"]["Enums"]["dealership_status"]
          updated_at: string
          user_id: string | null
        }
        Insert: {
      ...
      services: {
        ...
        Relationships: [
          {
            foreignKeyName: "services_assigned_employee_id_fkey"
          ...
          {
            foreignKeyName: "services_dealership_id_fkey"
            columns: ["dealership_id"]
            isOneToOne: false
            referencedRelation: "dealerships"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_employee_of_dealership: {
        Args: { _dealership_id: string; _user_id?: string }
        Returns: boolean
      }
    }
    Enums: {
      app_role: "admin" | "dealership" | "employee"
      dealership_status: "active" | "disabled"
